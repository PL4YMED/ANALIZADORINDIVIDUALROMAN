...
public class Analizador extends javax.swing.JFrame implements ActionListener
{
	...
	private FileNameExtensionFilter filtro = new FileNameExtensionFilter("archivos con extensión .RMA", "RMA");
	...
	private void GuardarComo()
	{
		try
		{
			...
			jfc = new JFileChooser();
			jfc.setSelectedFile(new File("programa.RMA"));
			jfc.setFileSelectionMode(JFileChooser.FILES_ONLY);
			jfc.setFileFilter(filtro);
	...
	private void analisisLexico()
	{
		...
		try
		{
			File temporal = new File("temporal.RMA");
    ...
    private void initComponents() {
        ...
        bAnalizar.setBackground(new java.awt.Color(65, 186, 50));
